  ...
  <ol>
    ...
    <li><a href="#documentation">Documentation</a>
      <ul>
        ...
        <li><a href="#x_kib-x_mib-x_gib-x_tib-x_pib">x_KiB, x_MiB, x_GiB, x_TiB, x_PiB</a></li>
        ...
        <li><a href="#x_delete-x_delete_array">x_delete, x_delete_array</a></li>
        ...
        <li><a href="#x_timing">x_tictoc</a></li>
      </ul>
    </li>
